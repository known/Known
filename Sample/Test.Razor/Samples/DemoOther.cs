...
class DemoOther : BaseComponent
{
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.Component<Known.Razor.Components.Timer>().Build();
        ...
        {
            attr.Style("width:50%;");
            builder.Component<Card>().Set(c => c.Title, "Card1").Build();
        });
        builder.Div("demo-box", attr =>
        {
            attr.Style("width:50%;");
            builder.Component<Card>().Set(c => c.Icon, "fa fa-list").Set(c => c.Title, "Card2").Build();
        });
