...
{
    public static WebApplicationBuilder AddKBlazorApp(this WebApplicationBuilder builder, AppOption option)
    {
    ...
    public static WebApplication UseKBlazorApp(this WebApplication app, AppOption option)
    {
