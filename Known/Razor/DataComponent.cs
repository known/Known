...
public class DataComponent<TItem> : BaseComponent
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        if (Data == null)
            await QueryPageDataAsync(null, false);
    ...
    internal void BuildEmpty(RenderTreeBuilder builder) => builder.Component<KEmpty>().Set(c => c.Text, EmptyText).Build();
    ...
    internal virtual void BuildPager(RenderTreeBuilder builder)
    {
        ...
        builder.Component<KPager>()
               ...
               .Set(c => c.OnPageChanged, OnPageChangedAsync)
    ...
    private async Task OnPageChangedAsync(PagingCriteria criteria)
    {
        await QueryPageDataAsync(criteria);
    }

    private async Task QueryPageDataAsync(PagingCriteria pc = null, bool isRefresh = true)
    {
        SelectedItems.Clear();
        ...
        var data = await OnQueryDataAsync(criteria);
        if (data == null)
        {
            TotalCount = 0;
            Data = null;
