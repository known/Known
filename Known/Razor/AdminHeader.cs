...
class AdminHeader : BaseComponent
{
    ...
    private string IsActive(KMenuItem menu) => curMenu?.Id == menu.Id ? "active" : "";
    ...
    [Parameter] public Action<KMenuItem> OnMenuClick { get; set; }
    ...
    private void BuildMenus(RenderTreeBuilder builder, List<KMenuItem> menus)
    {
    ...
    private void OnTopMenuClick(KMenuItem item)
    {
        curMenu = item;
