...
public class KTimeline : BaseComponent
{
    [Parameter] public string Style { get; set; }
    [Parameter] public List<KTimelineItem> Items { get; set; }
    ...
    private static void BuildItem(RenderTreeBuilder builder, KTimelineItem item)
    {
