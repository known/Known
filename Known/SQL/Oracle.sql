...
alter table SysUserMessage add constraint PK_SysUserMessage primary key(Id);
...
create table SysFlow(
    ...
    CurrById   varchar2(200)  not null,
    CurrBy     varchar2(100)  not null,
    PrevStep   varchar2(50)   null,
    PrevById   varchar2(200)  null,
    PrevBy     varchar2(100)  null,
    NextStep   varchar2(50)   null,
    NextById   varchar2(200)  null,
    NextBy     varchar2(100)  null
);
...
create table SysFlowLog(
    ...
    ExecuteById varchar2(50)   not null,
