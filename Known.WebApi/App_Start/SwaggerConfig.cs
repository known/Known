...
namespace Known.WebApi
{
    public class SwaggerConfig
    {
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "Known.WebApi");
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    //c.InjectJavaScript(thisAssembly, "Known.WebApi.Scripts.swagger_lang.js");
        ...
        internal static string GetXmlCommentsPath()
        {
            ...
            return string.Format("{0}/bin/Known.WebApi.xml", baseDirectory);
        }
    }
