...
namespace Known.Tests.Core.Extensions
{
    public class StringExtensionTest
    {
        public static void TestAppendLine()
        {
            ...
            Assert.AreEqual(sb.ToString(), "Item1不能为空！" + Environment.NewLine);
        }

        public static void TestByteLength()
        {
            var value = "Item1不能为空！";
            Assert.AreEqual(value.ByteLength(), 15);
        }

        public static void TestByteSubstring()
        {
            var value = "Item1不能为空！";
            Assert.AreEqual(value.ByteSubstring(5), "不能为空！");
        }

        public static void TestByteSubstringWithLength()
        {
            var value = "Item1不能为空！";
            Assert.AreEqual(value.ByteSubstring(5, 4), "不能");
        }
        ...
        public static void TestFormatXml()
        {
            ...
            Assert.AreEqual(valueXml.FormatXml(), value1.ToXml());
        }
    }
}
